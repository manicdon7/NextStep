            ...
            <FadeIn>
              ...
              <FadeIn delay={0.2}>
                <p className="text-xl text-white/70 max-w-2xl mx-auto">
                  Navigate your career path with AI-powered guidance, personalized resources, and skill development tools
                ...
                {[
                  {
                    ...
                    description:
                      "Take our AI-powered quiz to discover your strengths, get personalized insights about your thinking patterns and potential career paths.",
                  },
                  {
                    icon: BookOpen,
                    title: "Train Your Skills (TYS)",
                    description:
                      "Access curated learning resources, including documents, videos, and websites. Get AI chatbot assistance for your learning journey.",
                  },
                  {
                    icon: MessageSquare,
                    title: "Soft Skills Development",
                    description:
                      "Enhance your communication, presentation, and interpersonal skills with AI-guided practice and feedback.",
                  },
                  {
                    icon: Briefcase,
                    title: "Job & Freelance Portal",
                    description:
                      "Find opportunities that match your skills with AI-driven job suggestions and freelance project recommendations.",
                  },
                ].map((module, index) => (
                  <FadeInStaggerItem key={index}>
                    <ScaleOnHover>
                      <div className="bg-white/5 border-white/10 backdrop-blur-sm">
                        <div>
            ...
            <FadeIn>
              <div className="text-center mb-12">
                ...
                <p className="text-white/70 max-w-2xl mx-auto">
                  Our platform combines cutting-edge AI technology with comprehensive career development tools to give you
                  the edge you need.
                </p>
              </div>
            </FadeIn>
